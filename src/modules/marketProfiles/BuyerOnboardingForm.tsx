...
import { createMarketBuyerProfileRecord } from "./dbMarketBuyerProfileRecordUtils";
import { pb } from "@/config/pocketbaseConfig";
import { toast } from "sonner";

export const BuyerOnboardingForm = (p: { user: TUser }) => {
  ...
  return (
    <form
      onSubmit={async (e) => {
        ...
        const resp = await (() => {
          ...
          return createMarketBuyerProfileRecord({ pb, data });
        })();

        toast(
          resp.success ? "Successfully submitted your buyer profile!" : "Something went wrong!",
          { duration: 10_000 },
        );
      }}
    ...
    >
      ...
      <div>
        <Label id="buyer-description-input" />
        <TextInput
          id="buyer-description-input"
      ...
      <div>
        <Label id="buyer-imageUrl-input" />
        <FileInput
          id="buyer-imageUrl-input"
